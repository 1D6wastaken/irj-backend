...
func storeMonuLieuxDocumentSubmissionValidationEvent(_ context.Context, s *BusinessService, exData *approveRejectMonumentLieuExchangeData) approveRejectMonumentLieuState {
	...
	return sendApprovalEmailMonuLieu
}
...
func storeMonuLieuxDocumentSubmissionRejectionEvent(_ context.Context, s *BusinessService, exData *approveRejectMonumentLieuExchangeData) approveRejectMonumentLieuState {
	...
	return sendRejectionEmailMonuLieu
}
...
//nolint:lll
func sendApprovalEmailMonuLieu(_ context.Context, s *BusinessService, exData *approveRejectMonumentLieuExchangeData) approveRejectMonumentLieuState {
	...
	go func(logger *zerolog.Logger, userID string, id int32, title string, isUpdate bool) {
		...
		if err := s.smtpService.SendDocumentApprovedMail(ctx, to, smtp.SourceMonumentsLieux, id, isUpdate, title); err != nil {
...
//nolint:lll
func sendRejectionEmailMonuLieu(_ context.Context, s *BusinessService, exData *approveRejectMonumentLieuExchangeData) approveRejectMonumentLieuState {
	if !exData.documents.UserID.Valid {
		return nil
	}
