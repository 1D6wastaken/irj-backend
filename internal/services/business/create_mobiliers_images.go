...
func (b *BusinessService) CreateMobilierImage(w http.ResponseWriter, r *http.Request) *_http.APIError {
...
type createMobilierImageExchangeData struct {
...
type createMobilierImageState func(ctx context.Context, s *BusinessService, data *createMobilierImageExchangeData) createMobilierImageState

func processCreateMobilierImage(ctx context.Context, s *BusinessService, token *jwt.SessionInfo, req *api.MobilierImageCreationBody) error {
	logger := zerolog.Ctx(ctx)
	ctx, cancel := context.WithTimeout(ctx, defaultTimeOut)

	defer cancel()

	exData := createMobilierImageExchangeData{
		logger: logger,
		params: req,
		token:  token,
	}
	...
	go func() {
		...
		for state := createMobilierImage; state != nil; {
...
//nolint:cyclop
func linkMobilierImage(ctx context.Context, s *BusinessService, exData *createMobilierImageExchangeData) createMobilierImageState {
...
func addAuteurToMobilierImage(ctx context.Context, s *BusinessService, exData *createMobilierImageExchangeData) createMobilierImageState {
	...
	return sendNewMobilierImageDocumentMail
}

//nolint:lll
func sendNewMobilierImageDocumentMail(_ context.Context, s *BusinessService, exData *createMobilierImageExchangeData) createMobilierImageState {
	s.stopper.Hold(1)
	...
	go func(s *BusinessService, logger *zerolog.Logger, id int32) {
		...
		_ = s.smtpService.SendNewDocumentMail(ctx, to, smtp.SourceMobiliersImages, id)
