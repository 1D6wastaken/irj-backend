...
//nolint:lll
func (s *SMTPService) SendNewUserEmail(ctx context.Context, to []EmailPerson) error {
	subject := "Un utilisateur souhaite devenir contributeur !"
...
<head>
  ...
  <title>Nouvelle candidature - Le site du Patrimoine Saint-Jacques</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; padding:20px; border:1px solid #e0e0e0;">
          <tr>
            <td style="color:#333333; font-size:16px; line-height:1.5;">
              ...
              <p>Un nouvel utilisateur vient de soumettre sa candidature pour devenir <strong>contributeur</strong> sur <em>Le site du Patrimoine Saint-Jacques</em>.</p>
              <p>Veuillez vous connecter à votre espace d’administration pour examiner sa demande et prendre les mesures appropriées.</p>
            </td>
          </tr>
          <tr>
...
Un nouvel utilisateur vient de soumettre sa candidature pour devenir contributeur sur "Le site du Patrimoine Saint-Jacques".

Veuillez vous connecter à votre espace d'administration pour examiner sa demande.

Lien vers l'admin : https://test.saintjacquesinfo.eu/#
`
