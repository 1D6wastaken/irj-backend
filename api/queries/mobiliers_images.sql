...
VALUES (sqlc.arg(titre_mob_img),
        ...
        sqlc.arg(cote_reference),
        sqlc.arg(date_fabrication),
        sqlc.arg(auteur_oeuvre),
        sqlc.arg(commanditaire),
        sqlc.arg(emplacement),
        sqlc.arg(support),
        sqlc.arg(proprietaire_actuel),
        sqlc.arg(dimensions_support),
        sqlc.arg(dimensions_image))
